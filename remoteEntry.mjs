  ...
  */ // eslint-disable-next-line @typescript-eslint/member-ordering
  initializeSharing(shareScopeName = DEFAULT_SCOPE, extraOptions) {
    ...
    const initRemoteModule = /*#__PURE__*/function () {
      ...
      return function initRemoteModule(_x0) {
...
class FederationHost {
  ...
  loadShare(pkgName, extraOptions) {
    var _this0 = this;
    return _asyncToGenerator(function* () {
      return _this0.sharedHandler.loadShare(pkgName, extraOptions);
    })();
  }
  // The lib function will only be available if the shared set by eager or runtime init is set or the shared is successfully loaded.
  // 1. If the loaded shared already exists globally, then it will be reused
  ...
  loadRemote(id, options) {
    var _this1 = this;
    return _asyncToGenerator(function* () {
      return _this1.remoteHandler.loadRemote(id, options);
    })();
  }
  // eslint-disable-next-line @typescript-eslint/member-ordering
  preloadRemote(preloadOptions) {
    var _this10 = this;
    return _asyncToGenerator(function* () {
      return _this10.remoteHandler.preloadRemote(preloadOptions);
    })();
  }
  initShareScopeMap(scopeName, shareScope, extraOptions = {}) {
...
/* harmony import */ var _home_runner_work_mf_remote_mf_remote_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(993);


if(!__webpack_require__.federation.runtime){
	var prevFederation = __webpack_require__.federation;
	__webpack_require__.federation = {}
	for(var key in _home_runner_work_mf_remote_mf_remote_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0__){
		__webpack_require__.federation[key] = _home_runner_work_mf_remote_mf_remote_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0__[key];
	}
...
/******/ 			scope: ["default"],
/******/ 			shareConfig: {"eager":false,"requiredVersion":"~19.2.0","strictVersion":true,"singleton":true}},],	"@angular/core/primitives/di": [{	version: "19.2.11",
/******/ 			get: () => (__webpack_require__.e(76).then(() => (() => (__webpack_require__(2056))))),
/******/ 			scope: ["default"],
/******/ 			shareConfig: {"eager":false,"requiredVersion":"~19.2.0","strictVersion":true,"singleton":true}},],	"@angular/core/primitives/signals": [{	version: "19.2.11",
